...
public class DBA {
    ...
    // Metods Ubicación
    public void InsertUbicaciones(int idT, String ubicacion) {
        CallableStatement stmt = null;
        try {
            if (conexion == null || conexion.isClosed()) {
                conectar();
            ...
            JOptionPane.showMessageDialog(null, "Error al insertar al: " + e.getMessage(), "Error_UBI", JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                if (stmt != null) {
                    stmt.close();
    ...
    public void InsertFacturas(int idT, int idC, Date fecha, float subtotal, String ISV, float Total) {
        ...
        try {
            ...
            String sql = "{CALL insertarFacturas(?, ?, ?, ?, ?, ?)}";
            stmt = conexion.prepareCall(sql);
            ...
            JOptionPane.showMessageDialog(null, "Error al insertar al: " + e.getMessage(), "Error_FC", JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                if (stmt != null) {
                    stmt.close();
